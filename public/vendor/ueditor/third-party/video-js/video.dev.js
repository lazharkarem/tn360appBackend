...
vjs.getComputedDimension = function (el, strCssRule) {
    ...
    if (document.defaultView && document.defaultView.getComputedStyle) {
        ...
        strValue =
            el[
                "client" +
                    strCssRule.substr(0, 1).toUpperCase() +
                    strCssRule.substr(1)
            ] + "px";
    }
    return strValue;
...
vjs.Component.prototype.addChild = function (child, options) {
    ...
    if (typeof child === "string") {
        ...
        componentClass =
            options["componentClass"] || vjs.capitalize(componentName);
...
vjs.CurrentTimeDisplay.prototype.createEl = function () {
    ...
    this.content = vjs.createEl("div", {
        ...
        innerHTML:
            '<span class="vjs-control-text">Current Time </span>' + "0:00", // label the current time for screen reader users
...
vjs.DurationDisplay.prototype.createEl = function () {
    ...
    this.content = vjs.createEl("div", {
        ...
        innerHTML:
            '<span class="vjs-control-text">Duration Time </span>' + "0:00", // label the duration time for screen reader users
        "aria-live": "off", // tell screen readers not to automatically read the time as it changes
    });
...
vjs.SeekBar.prototype.updateARIAAttributes = function () {
    ...
    this.el_.setAttribute(
        "aria-valuenow",
        vjs.round(this.getPercent() * 100, 2)
...
vjs.MediaLoader = vjs.Component.extend({
    ...
    init: function (player, options, ready) {
        ...
        if (
            ...
            for (
                var i = 0, j = player.options_["techOrder"];
                i < j.length;
                i++
            ) {
                var techName = vjs.capitalize(j[i]),
    ...
    if (this.cues_.length > 0) {
        ...
        if (
            ...
            if (time >= this.nextChange || this.nextChange === undefined) {
                ...
                i =
                    this.firstActiveIndex !== undefined
