/*! Video.js v4.3.0 Copyright 2013 Brightcove, Inc. https://github.com/videojs/video.js/blob/master/LICENSE */ (function () {
    ...
    u.Tb = "4.3";
    u.Fc = "https:" == document.location.protocol ? "https://" : "https://";
    u.options = {
        ...
        e.W ||
            ...
            (e.W = function (c) {
                if (!e.disabled) {
                    ...
                    if (d)
                        for (
                            var d = d.slice(0), k = 0, q = d.length;
                            k < q && !c.pc();
                            k++
                        )
                            d[k].call(a, c);
    ...
    u.Kd = function (a, c) {
        ...
        document.defaultView && document.defaultView.getComputedStyle
            ...
            : a.currentStyle &&
              (d =
                  a["client" + c.substr(0, 1).toUpperCase() + c.substr(1)] +
                  "px");
        return d;
    };
    u.zb = function (a, c) {
    ...
    u.c = u.la.extend({
        i: function (a, c, d) {
            ...
            this.Q =
                c.id ||
                (c.el && c.el.id ? c.el.id : a.id() + "_component_" + u.t++);
            this.gd = c.name || h;
            this.a = c.el || this.e();
            this.G = [];
            this.qb = {};
    ...
    if ("undefined" !== typeof window.JSON && "function" === window.JSON.parse)
        ...
        u.JSON.parse = function (a, c) {
            ...
            throw new SyntaxError(
                "JSON.parse(): invalid or malformed JSON data"
            );
        };
    }
    u.fc = function () {
