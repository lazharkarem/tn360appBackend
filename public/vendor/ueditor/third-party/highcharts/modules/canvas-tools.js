...
(function () {
    function m() {
            ...
            this.render = function (b) {
                if (
                    ...
                    if (this.attribute("mask").hasValue()) {
                        var a =
                            this.attribute("mask").Definition.getDefinition();
        ...
        a.Element.RenderedElementBase = function (c) {
            ...
            this.setContext = function (d) {
                ...
                if (this.style("stroke").Definition.isUrl()) {
                    if (
                        ((b =
                            this.style("stroke").Definition.getFillStyle(this)),
                        b != null)
                    )
                        d.strokeStyle = b;
                ...
                this.attribute("clip-path").hasValue() &&
                    ((b =
                        this.attribute("clip-path").Definition.getDefinition()),
                    b != null && b.apply(d));
        ...
        a.Element.PathElementBase.prototype =
            new a.Element.RenderedElementBase();
                ...
                if (d.type == "font-face")
                    (this.fontFace = d),
                        d.style("font-family").hasValue() &&
                            (a.Definitions[d.style("font-family").value] =
                                this);
        ...
        a.Element.TextElementBase.prototype =
            new a.Element.RenderedElementBase();
        ...
        a.Element.use = function (c) {
            ...
            this.getDefinition = function () {
                ...
                if (this.attribute("width").hasValue())
                    a.attribute("width", !0).value =
                        this.attribute("width").value;
                if (this.attribute("height").hasValue())
                    a.attribute("height", !0).value =
                        this.attribute("height").value;
                return a;
            };
            this.path = function (a) {
