            ...
            ($ && {
                ...
                init: function (pathAnim) {
                    ...
                    $.fn.highcharts = function () {
                        ...
                        if (options === UNDEFINED) {
                            ret =
                                charts[attr(this[0], "data-highcharts-chart")];
                        }
    ...
    Tick.prototype = {
        ...
        getLabelSides: function () {
            var bBox = this.labelBBox, // assume getLabelSize has run at this point
                ...
                leftSide =
                    width *
                        { left: 0, center: 0.5, right: 1 }[axis.labelAlign] -
                    labelOptions.x;
        ...
        handleOverflow: function (legendHeight) {
            ...
            if (legendHeight > spaceHeight && !options.useHTML) {
                this.clipHeight = clipHeight =
                    spaceHeight - 20 - this.titleHeight;
    ...
    Series.prototype = {
        ...
        init: function (chart, options) {
            ...
            stableSort(chartSeries, function (a, b) {
                return (
                    pick(a.options.index, a._i) - pick(b.options.index, a._i)
                );
            });
        ...
        render: function () {
            var series = this,
                ...
                doAnimation =
                    animation && !!series.animate && chart.renderer.isSVG, // this animation doesn't work in IE8 quirks when the group div is hidden,
