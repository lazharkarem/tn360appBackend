...
(function () {
    ...
    function Eb(a, b, c, d) {
        ...
        if (u(b)) {
            ...
            j >= D[Ra] &&
                (i[Hb](j >= D[Da] ? 0 : k * P(i[$a]() / k)), (h = i[ab]()));
            j >= D[Da] && ((h -= h % k), i[Ib](h));
                    ...
                    a.fn.highcharts = function () {
                        ...
                        if (c !== w)
                            (c.chart = c.chart || {}),
                                ...
                                (d = this);
                        c === w &&
                            (d = Ga[v(this[0], "data-highcharts-chart")]);
                        return d;
                    };
                },
    ...
    M = {
        ...
        global: {
            useUTC: !0,
            canvasToolsURL:
                "https://code.highcharts.com/3.0.6/modules/canvas-tools.js",
            VMLRadialGradientURL:
                "https://code.highcharts.com/3.0.6/gfx/vml-radial-gradient.png",
        },
        chart: {
            borderColor: "#4572A7",
            borderRadius: 5,
    ...
    Ha.prototype = {
        ...
        init: function (a, b, c, d) {
            ...
            this.createElement("desc")
                .add()
                .element.appendChild(
                    y.createTextNode("Created with Highcharts 3.0.6")
                );
        ...
        button: function (a, b, c, d, e, f, g, h) {
            ...
            J(i.element, ta ? "mouseout" : "mouseleave", function () {
                j !== 3 &&
                    ((k = [e, f, g][j]), (l = [m, p, q][j]), i.attr(k).css(l));
            });
        ...
        label: function (a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                a = o.element.style;
                L =
                    (Oa === void 0 || la === void 0 || q.styles.textAlign) &&
                    o.getBBox();
                ...
                if (C) {
                    if (!A)
                        (a = t(-s * da)),
                            ...
                            A.add(q);
                    A.isImg ||
                        A.attr(x({ width: q.width, height: q.height }, lb));
                    lb = null;
                }
            }
            function k() {
    ...
    if ($)
        (Highcharts.CanVGRenderer = F =
            function () {
                za = "https://www.w3.org/1999/xhtml";
            }),
            (F.prototype.symbols = {}),
            (Tb = (function () {
                function a() {
        ...
        render: function (a, b, c) {
            ...
            if (q) {
                ...
                if (l === w) {
                    ...
                    if (b) l.opacity = 0;
                    this.gridLine = l = q
                        ? f.path(j).attr(l).add(d.gridGroup)
                        : null;
                }
                if (!b && l && j)
    ...
    vb.prototype = {
        render: function () {
            ...
            if (p)
                ...
                q &&
                q.length &&
                ((a.svgElem = p = w.path(q).attr(d).add()), t)
            )
    ...
    db.prototype = {
        ...
        getPlotLinePath: function (a, b, c, d) {
            ...
            if (isNaN(a)) m = !0;
                ...
                ((c = f), (i = l - this.right), h < g || h > g + this.height)
            )
                m = !0;
            return m && !d
                ? null
        ...
        adjustForMinRange: function () {
            ...
            if (c - b < this.minRange) {
                ...
                c = Ja(c);
                c - b < k &&
                    ((d[0] = c - k), (d[1] = o(a.min, c - k)), (b = va(d)));
            }
            this.min = b;
            this.max = c;
        },
                ...
                if (a.horiz && !a.staggerLines && x && !q.rotation) {
                    for (r = a.reversed ? [].concat(e).reverse() : e; v < x; ) {
                        ...
                        for (q = 0; q < r.length; q++)
                            (E = r[q]),
                                (H = (H = f[E].label && f[E].label.getBBox())
                                    ? H.width
                                    : 0),
                                (B = q % v),
                                H &&
        ...
        render: function () {
            ...
            if (A || f)
                if (
                    ...
                    n(
                        (d.plotLines || []).concat(d.plotBands || []),
                        function (b) {
    ...
    eb.prototype = {
        ...
        renderItem: function (a) {
            ...
            f
                ? (b.itemX += e)
                : ((b.itemY += n + g + q), (b.lastLineHeight = g));
            b.offsetWidth =
    ...
    yb.prototype = {
        ...
        getMargins: function () {
            ...
            if (k && !u(d[0]))
                this.plotTop = s(
                    this.plotTop,
                    k + this.options.title.margin + a[0]
                );
        ...
        drawChartBox: function () {
            ...
            if (l)
                h
                    ? h.animate(t)
                    : (this.plotBGImage = b.image(l, q, o, n, s).add());
            u
    ...
    Q.prototype = {
        ...
        translate: function () {
            ...
            for (
                ...
                var l = f[a],
                    ...
                    n =
                        e.stacks[
                            (this.negStacks && p < k ? "-" : "") + this.stackKey
                        ];
        ...
        drawTracker: function () {
            ...
            if (e && !c)
                for (m = e + 1; m--; )
                    d[m] === "M" &&
                        d.splice(m + 1, 0, d[m + 1] - i, d[m + 2], "L"),
                        ((m && d[m] === "M") || m === e) &&
