(function () {
    (function () {
        ...
        var f = !!window.ActiveXObject,
            h = {
                ...
                extend: function (a, c) {
                    for (
                        var b = arguments,
                            d = this.isBoolean(b[b.length - 1])
                                ? b[b.length - 1]
                                : !1,
                            e = this.isBoolean(b[b.length - 1])
                                ? b.length - 1
                                : b.length,
                            k = 1;
                        k < e;
                ...
                cssRule: f
                    ? function (a, c, b) {
                          ...
                          if (d[a]) e = b.styleSheets[d[a]];
                              ...
                              if (void 0 === c) return "";
                              e = b.createStyleSheet(
                                  "",
                                  (b = b.styleSheets.length)
                              );
                              d[a] = b;
                          }
        ...
        h.each(
            "String Function Array Number RegExp Object Boolean".split(" "),
            function (a) {
                h["is" + a] = function (c) {
                    return (
            ...
            f.each(a, function (a) {
                if (/\bsortEnabled\b/.test(a.className))
                    f.on(a, "click", function (a) {
                        ...
                        if (
                            -1 != c &&
                            (b(a, c, h.tableSortCompareFn || l),
                            !f.hasClass(a.rows[0], "firstRow"))
                        ) {
    ...
    UE.parse.register("charts", function (f) {
        ...
        function g(a) {
            for (
                var c = a.getAttribute("data-chart"), b = {}, d = [], f = 0, e;
                (e = a.rows[f]);
                f++
            ) {
        ...
        function b() {
            f.loadFile(
                ...
                function () {
                    for (
                        var a = null, c = null, b = null, d = 0, f = k.length;
                        d < f;
                        d++
                    ) {
                        var a = k[d],
    ...
    UE.parse.register("background", function (f) {
        for (
            var h = this.root.getElementsByTagName("p"), g, a = 0, c;
            (c = h[a++]);

        )
            (g = c.getAttribute("data-background")) &&
