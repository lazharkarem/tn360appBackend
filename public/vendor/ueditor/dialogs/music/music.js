...
(function () {
    ...
    Music.prototype = {
        ...
        pageSize: 10,
        dataUrl:
            "https://tingapi.ting.baidu.com/v1/restserver/ting?method=baidu.ting.search.common",
        ...
        _buildMusicHtml: function (playerUrl) {
            var html =
                '<embed class="BDE_try_Music" allowfullscreen="false" pluginspage="https://www.macromedia.com/go/getflashplayer"';
            html += ' src="' + playerUrl + '"';
            html +=
                ' width="1" height="1" style="position:absolute;left:-2000px;"';
            html +=
        ...
        _renderTemplate: function (data) {
            ...
            for (var i = 0, tmpList; (tmpList = data[i++]); ) {
                ...
                for (var j = 0, tmpObj; (tmpObj = tmpList[j++]); ) {
                    ...
                    s.push(
                        '<span class="m-t">' +
                            me._getMaxText(tmpObj.title) +
                            "</span>"
                    );
                    s.push(
                        '<span class="m-s">' +
                            me._getMaxText(tmpObj.author) +
                            "</span>"
                    );
                    s.push(
                        '<span class="m-z">' +
