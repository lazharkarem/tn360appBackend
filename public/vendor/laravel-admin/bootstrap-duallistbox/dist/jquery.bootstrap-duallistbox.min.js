...
!(function (a, b, c, d) {
    ...
    function g(b) {
        b.element.find("option").each(function (c, d) {
            ...
            "undefined" == typeof e.data("original-index") &&
                ...
                "undefined" == typeof e.data("_selected") &&
                    e.data("_selected", !1);
        });
    }
    function h(b, c, d) {
    ...
    function l(b, c) {
        if (b.settings.showFilterInputs) {
            ...
            var d = new RegExp(
                    a.trim(b.elements["filterInput" + c].val()),
                    "gi"
                ),
            ...
            (f = 1 === c ? e.not(":selected") : f.find("option:selected")),
                f.each(function (f, g) {
                    var h = a(g),
                        i = !0;
                    (g.text.match(d) ||
                        (b.settings.filterOnValues &&
                            h.attr("value").match(d))) &&
                        ((i = !1),
    ...
    function m(b, c) {
        ...
        b.elements["select" + c].find("option").each(function (b, c) {
            var e = a(c);
            d.eq(e.data("original-index")).data(
                "_selected",
                e.prop("selected")
            );
        });
    ...
    (e.prototype = {
        init: function () {
            ...
            return (
                ...
                (this.sortIndex = 0),
                (this.elementCount = 0),
                this.setBootstrap2Compatible(
                    this.settings.bootstrap2Compatible
                ),
        ...
        setInfoTextFiltered: function (a, b) {
            return (
                (this.settings.infoTextFiltered = a), b && k(this), this.element
            );
        },
        setInfoTextEmpty: function (a, b) {
            return (
                (this.settings.infoTextEmpty = a), b && k(this), this.element
            );
        },
        setFilterOnValues: function (a, b) {
            return (
                (this.settings.filterOnValues = a), b && k(this), this.element
            );
        },
        setSortByInputOrder: function (a, b) {
            return (
                (this.settings.sortByInputOrder = a), b && k(this), this.element
            );
        },
        setEventMoveOverride: function (a, b) {
            return (
                (this.settings.eventMoveOverride = a),
                b && k(this),
                this.element
            );
        },
        setEventMoveAllOverride: function (a, b) {
            return (
                (this.settings.eventMoveAllOverride = a),
                b && k(this),
                this.element
            );
        },
        setEventRemoveOverride: function (a, b) {
            return (
                (this.settings.eventRemoveOverride = a),
                b && k(this),
                this.element
            );
        },
        setEventRemoveAllOverride: function (a, b) {
            return (
                (this.settings.eventRemoveAllOverride = a),
                b && k(this),
                this.element
            );
        },
