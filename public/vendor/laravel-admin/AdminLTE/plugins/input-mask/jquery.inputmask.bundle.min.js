    ...
    function h(e, f, g) {
        ...
        function p(b, c, d, e) {
            if (
                ...
                if (!k)
                    return (
                        (m().validPositions = a.extend(!0, {}, h)), n(!0), !1
                    );
        ...
        function q(a, b, c, d) {
            ...
            var f,
                h = a;
            for (m().p = a, f = b - 1; f >= h; f--)
                void 0 !== m().validPositions[f] &&
                    (c === !0 ||
                        (!e(f) &&
                            g.canClearPosition(m(), f, o(), d, g) !== !1)) &&
            ...
            for (n(!0), f = h + 1; f <= o(); ) {
                ...
                if (
                    (h > f && (f = h + 1),
                    (void 0 === m().validPositions[f] && C(f)) || void 0 !== i)
                )
                    f++;
                else {
                    var j = r(f);
        ...
        function B(c, d, e, f) {
            function h(a) {
                return ja
                    ? a.begin - a.end > 1 ||
                          (a.begin - a.end === 1 && g.insertMode)
                    : a.end - a.begin > 1 ||
                          (a.end - a.begin === 1 && g.insertMode);
            }
            function i(b, d, e, f) {
                var i = !1;
                return (
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    return (i.pos = o()), !1;
                                if (
                                    ((v = void 0 !== i.pos ? i.pos : b),
                                    v !== b)
                                )
                                    return (
                                        (i = a.extend(i, B(v, u, !0, f))), !1
                                    );
                            } else if (
                                i !== !0 &&
                                void 0 !== i.pos &&
        ...
        function D() {
            var a;
            (ha = void 0 !== fa ? fa.maxLength : void 0),
                -1 === ha && (ha = void 0);
            var b,
                c = o(),
            ...
            var f = s(b - 1);
            return (
                (a = "" !== f.def ? b : b - 1), void 0 === ha || ha > a ? a : ha
            );
        }
        function E(a, b) {
            var c = D();
            ...
            if ((n(), (m().p = E(-1)), !e))
                if (g.autoUnmask !== !0) {
                    var p = w().slice(0, E(-1)).join(""),
                        q = j
                            .join("")
                            .match(new RegExp("^" + b.escapeRegex(p), "g"));
                    q &&
                        q.length > 0 &&
                        (j.splice(0, q.length * p.length), (l = E(l)));
                } else l = E(l);
        ...
        function T(b) {
            ...
            j === (ja ? w().reverse() : w()).slice(0, i.begin).join("") &&
                (j = ""),
                k === (ja ? w().reverse() : w()).slice(i.end).join("") &&
                    (k = ""),
                ja && ((c = j), (j = k), (k = c)),
            ...
            return (
                J(
                    ...
                    !1,
                    !1,
                    ja ? l.split("").reverse() : l.toString().split("")
                ),
                H(d, x(), E(o()), b, !0),
                O(x()) === !0 && f.trigger("complete"),
                b.preventDefault()
        ...
        function da(b) {
            if (
                ...
                ("rtl" === fa.dir || g.rightAlign) &&
                    (fa.style.textAlign = "right"),
                    ...
                    onBeforeWrite: function (c, d, e, f) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                (i = i.replace(
                                    new RegExp(
                                        b.escapeRegex(f.negationSymbol.back) +
                                            "$"
                                    ),
                                    ""
                                )),
                                (i =
                                    i === f.negationSymbol.front ? i + "0" : i),
                                "" !== i && isFinite(i))
                            ) {
                                var k = parseFloat(i),
                                    l = j ? -1 * k : k;
                                if (
                                    ...
                                    for (var o = 1; o <= f.digits; o++)
                                        ...
                                        (void 0 !== i[m + o] &&
                                            i[m + o] !==
                                                f.placeholder.charAt(0))
                                            ? -1 !== n &&
                                              void 0 !== h[n + o] &&
                                              (i[m + o] = i[m + o] || h[n + o])
                                            : (i[m + o] = "0");
                                    i[i.length - 1] === f.radixPoint &&
                                        delete i[i.length - 1];
                                }
                                if (
                                    (k.toString() !== i &&
                        ...
                        return f.autoGroup
                            ? ((g = f.postFormat(
                              ...
                              (g.caret =
                                  e <= f.prefix.length ? g.pos : g.pos + 1),
                              g)
                            : void 0;
                    },
                    regex: {
                                ...
                                if (k && (-1 === j || j >= d)) {
                                    ...
                                    if (
                                        ...
                                        return (
                                            ...
                                            (d = k.index),
                                            { pos: d, remove: k.index }
                                        );
                                    if (
                                        "0" === b &&
                                        d <= k.index &&
                                        k[0] !== f.groupSeparator
                                    )
                                        return !1;
                                }
                            }
