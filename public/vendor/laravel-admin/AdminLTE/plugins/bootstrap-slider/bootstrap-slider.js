		...
		**************************************************/
        Slider.prototype = {
            ...
            setValue: function (val, triggerSlideEvent) {
                ...
                if (this.options.range) {
                    this.options.value[0] = applyPrecision(
                        this.options.value[0]
                    );
                    this.options.value[1] = applyPrecision(
                ...
                if (this.diff > 0) {
                    this.percentage = [
                        ((this.options.value[0] - this.options.min) * 100) /
                            this.diff,
                        ((this.options.value[1] - this.options.min) * 100) /
                            this.diff,
