...
class CreateDealDepenseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('deal_depense', function (Blueprint $table) {
            $table->id('ID_deal_depense');
    ...
    {
        Schema::dropIfExists('deal_depense');
    }
}
