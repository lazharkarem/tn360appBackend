...
class DealAnniversaireController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->number('objectif_2', __('Objectif 2'));
        $form->number('objectif_3', __('Objectif 3'));
        $form->number('objectif_4', __('Objectif 4'));
        $form->number('objectif_5', __('Objectif 5'));
        $form->number('gain_objectif_1', __('Gain Objectif 1'));
        $form->number('gain_objectif_2', __('Gain Objectif 2'));
        $form->number('gain_objectif_3', __('Gain Objectif 3'));
        $form->number('gain_objectif_4', __('Gain Objectif 4'));
        $form->number('gain_objectif_5', __('Gain Objectif 5'));
