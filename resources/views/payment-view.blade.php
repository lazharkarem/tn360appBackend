                                    ...
                                    <div class="card-body pb-0 pt-1" style="height: 70px">
                                        <form class="needs-validation" method="POST" id="payment-form"
                                            ...
                                            <center>
                                                ...
                                                <input class="btn btn-block" width="200"type="image" name="paypal"src="{{ asset('assets/admin/img/paypal.jpg') }}" alt="paypal" >

                                            </center>


                                            {{-- <button class="btn btn-block" type="submit"> --}}
                                                {{-- <img width="100" src="{{ asset('assets/admin/img/paypal.png') }}" class="center" /> --}}
                                                {{-- <img width="200" src="{{ asset('assets/admin/img/paypal.jpg') }}"  /> --}}
                                            {{-- </button> --}}
                                        </form>
                                    </div>
                                </div>
