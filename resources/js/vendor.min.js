 ...
 * https://www.sitepoint.com/blogs/2009/07/29/build-auto-expanding-textarea-1/
 *
    ...
    $.fn.TextAreaExpander = function (minHeight, maxHeight) {
        ...
        function ResizeTextarea(e) {
            ...
            if (vlen != e.valLength || ewidth != e.boxWidth) {
                ...
                var h = Math.max(
                    e.expandMin,
                    Math.min(e.scrollHeight, e.expandMax)
                );
        ...
        this.each(function () {
            ...
            this.expandMax =
                maxHeight || (p ? parseInt("0" + p[2], 10) : 99999);
...
(function ($) {
    $.fn.extend({
        ...
        renderCalendar: function (s) {
            ...
            if (s.showHeader != $.dpConst.SHOW_HEADER_NONE) {
                var headRow = $(dc("tr"));
                for (
                    var i = Date.firstDayOfWeek;
                    i < Date.firstDayOfWeek + 7;
                    i++
                ) {
                    var weekday = i % 7;
    ...
    $.extend(DatePicker.prototype, {
        ...
        setSelected: function (d, v, moveToMonth, dispatchEvents) {
            ...
            var selectorString =
                "td." +
                (d.getMonth() == this.displayedMonth
                    ? "current-month"
                    : "other-month");
            var $td;
            $(selectorString, this.context).each(function () {
                if ($(this).data("datePickerDate") == d.asString()) {
                    $td = $(this);
                    if (s.selectWeek) {
                        $td.parent()[v ? "addClass" : "removeClass"](
                            "selectedWeek"
                        );
                    }
            ...
            $("td", this.context)
                ...
                [
                    this.selectMultiple &&
                    this.numSelected == this.numSelectable
                        ? "addClass"
                        : "removeClass"
                ]("unselectable");
...
(function ($, window) {
        ...
        _startPolling: function (every) {
            ...
            if (!Sammy.HashLocationProxy._interval) {
                ...
                var hashCheck = function () {
                    ...
                    if (
                        !Sammy.HashLocationProxy._last_location ||
                        current_location !=
                            Sammy.HashLocationProxy._last_location
                    ) {
                ...
                hashCheck();
                Sammy.HashLocationProxy._interval = window.setInterval(
                    hashCheck,
                    every
                );
            }
    ...
    Sammy.Application = function (app_function) {
        ...
        if (!this._location_proxy) {
            this.setLocationProxy(
                new Sammy.HashLocationProxy(this, this.run_interval_every)
            );
        }
        if (this.debug) {
    ...
    Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
        ...
        // https://code.quirkey.com/sammy/doc/plugins.html
        //
        // ### Example
        //
        ...
        // For great detail on routes, check out: https://code.quirkey.com/sammy/doc/routes.html
        //
        ...
        route: function (verb, path, callback) {
            ...
            if (path.constructor == String) {
                ...
                path = new RegExp(
                    "^" + path.replace(PATH_NAME_MATCHER, PATH_REPLACER) + "$"
                );
            }
            // lookup callback
        ...
        trigger: function (name, data) {
            this.$element().trigger([name, this.eventNamespace()].join("."), [
                data,
            ]);
            return this;
        },
        ...
        run: function (start_url) {
            ...
            this.bind("submit", function (e) {
                var returned = app._checkFormSubmission(
        ...
        runRoute: function (verb, path, params, target) {
            ...
            if (route) {
                ...
                if (
                    (path_params = route.path.exec(this.routablePath(path))) !==
                    null
                ) {
                ...
                // set event context
                context = new this.context_prototype(
                    this,
                    verb,
                    path,
                    params,
        ...
        contextMatchesOptions: function (context, match_options, positive) {
            ...
            if (options.only) {
                ...
                return this.contextMatchesOptions(
                    context,
                    options.except,
                    false
                );
        ...
        _serializeFormParams: function ($form) {
            var queryString = "",
                ...
                i;
            if (fields.length > 0) {
                queryString = this._encodeFormPair(
                    fields[0].name,
                    fields[0].value
                );
    ...
    Sammy.RenderContext.prototype = $.extend({}, Sammy.Object.prototype, {
        ...
        then: function (callback) {
            if (!_isFunction(callback)) {
                ...
                if (
                    ...
                    callback in this.event_context
                ) {
        ...
        load: function (location, options, callback) {
            ...
            return this.then(function () {
                ...
                if (typeof location === "string") {
                    ...
                    should_cache =
                        (is_json && options.cache === true) ||
                        options.cache !== false;
                    context.next_engine =
                        context.event_context.engineFor(location);
                    ...
                    if (
                        should_cache &&
                        (cached =
                            this.event_context.app.templateCache(location))
                    ) {
                        return cached;
                    }
                    this.wait();
                        ...
                        $.extend(
                            {
                                ...
                                success: function (data) {
                                    if (should_cache) {
                                        context.event_context.app.templateCache(
                                            location,
                                            data
                                        );
                                    }
        ...
        renderEach: function (location, name, data, callback) {
            ...
            return this.load(location).then(function (content) {
                var rctx = this;
                if (!data) {
                    data = _isArray(this.previous_content)
                ...
                if (callback) {
                    $.each(data, function (i, value) {
                        ...
                        callback(
                            value,
                            rctx.event_context.interpolate(
                                content,
                                idata,
                                engine
                            )
                    ...
                    return this.collect(
                        ...
                        function (i, value) {
                            var idata = {},
                                engine = this.next_engine || location;
                            name ? (idata[name] = value) : (idata = value);
                            return this.event_context.interpolate(
                                content,
                                idata,
                                engine
                            );
    ...
    Sammy.EventContext.prototype = $.extend({}, Sammy.Object.prototype, {
        ...
        load: function (location, options, callback) {
            return new Sammy.RenderContext(this).load(
                location,
                options,
                callback
            );
...
(function ($) {
    ...
    EJS = function (options) {
        ...
        if (options.element) {
            ...
            if (options.url) {
                ...
                try {
                    this.text = EJS.request(
                        url + (this.cache ? "" : "?" + Math.random())
                    );
                } catch (e) {}
                if (this.text == null) {
                    throw {
    ...
    EJS.Helpers.prototype.hidden_field_tag = function (
        name,
        value,
        html_options
    ) {
    ...
    EJS.Helpers.prototype.input_field_tag = function (
        name,
        value,
        inputType,
        html_options
    ...
    EJS.Helpers.prototype.link_to_if = function (
        condition,
        name,
        url,
        html_options,
    ...
    EJS.Helpers.prototype.link_to_unless = function (
        condition,
        name,
        url,
        html_options,
    ...
    EJS.Helpers.prototype.link_to_unless_current = function (
        name,
        url,
        html_options,
        block
    ...
    EJS.Helpers.prototype.password_field_tag = function (
        name,
        value,
        html_options
    ) {
    ...
    EJS.Helpers.prototype.select_tag = function (
        name,
        value,
        choices,
        html_options
        ...
        for (var i = 0; i < choices.length; i++) {
            ...
            txt +=
                this.start_tag_for("option", optionOptions) +
                choice.text +
                this.tag_end("option");
        }
    ...
    EJS.Helpers.prototype.text_area_tag = function (name, value, html_options) {
        ...
        return (
            this.start_tag_for("textarea", html_options) +
            value +
            this.tag_end("textarea")
        );
    };
    EJS.Helpers.prototype.text_tag = EJS.Helpers.prototype.text_area_tag;
    EJS.Helpers.prototype.text_field_tag = function (
        name,
        value,
        html_options
    ) {
...
(function (a) {
    ...
    Sammy.Store = function (c) {
        ...
        this.storage = new Sammy.Store[Sammy.Store.stores[this.type]](
            this.name,
            this.element,
            this.options
        );
    ...
    a.extend(Sammy.Store.prototype, {
        ...
        set: function (c, d) {
            ...
            if (c != this.meta_key) {
                ...
                this.$element.trigger("set-" + this.name + "-" + c, {
                    key: c,
                    value: d,
                });
            }
    ...
    a.extend(Sammy.Store.Data.prototype, {
        isAvailable: function () {
            return true;
        },
        exists: function (b) {
    ...
    a.extend(Sammy.Store.LocalStorage.prototype, {
        isAvailable: function () {
            return (
                "localStorage" in window && window.location.protocol != "file:"
            );
        },
        exists: function (b) {
    ...
    a.extend(Sammy.Store.SessionStorage.prototype, {
        isAvailable: function () {
            return (
                "sessionStorage" in window &&
                window.location.protocol != "file:" &&
                a.isFunction(window.sessionStorage.setItem)
            );
        },
        exists: function (b) {
            return this.get(b) != null;
    ...
    a.extend(Sammy.Store.Cookie.prototype, {
        isAvailable: function () {
    ...
    Sammy.Storage = function (b) {
        ...
        this.store = function (d, c) {
            if (typeof this.stores[d] == "undefined") {
                ...
                this.stores[d] = new Sammy.Store(
                    a.extend(
                        { name: d, element: this.element_selector },
                        c || {}
                    )
                );
                this[d] = function (f, g) {
    ...
    Sammy.Session = function (c, b) {
        ...
        this.store(
            "session",
            a.extend({ type: ["local", "cookie", "memory"] }, b)
        );
    };
    Sammy.Cache = function (c, b) {
        ...
        this.store(
            "cache",
            a.extend({ type: ["local", "session", "memory"] }, b)
        );
    };
})(jQuery);
